...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock">
	...
	<ul>
		...
		<li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>"> 
			...
			<a class="k2Avatar moduleItemAuthorAvatar" rel="author" href="<?php echo $item->authorLink; ?>"> <img src="<?php echo $item->authorAvatar; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($item->author); ?>"/> </a>
			<?php endif; ?>
			<?php if($params->get('itemAuthor')): ?>
			<div class="moduleItemAuthor">
				<p class="author"><?php echo K2HelperUtilities::writtenBy($item->authorGender); ?>
