...
// $Id: slideshow.php 4120 2013-02-28 21:51:03Z erftralle $
...
?>
        caption: '<?php echo "<b>".strip_tags(str_replace($strip_arr,"",$img->imgtitle))."</b> ".strip_tags(str_replace($strip_arr,"",$img->imgtext)); ?>',
<?php
        else:
?>
        caption: '<?php echo strip_tags(str_replace($strip_arr,"",$img->imgtext)); ?>',
<?php
        endif;
      else:
?>
...
?>
    ...
    new <?php echo $transtypejs?>('slideshow<?php echo $moduleid;?>',
      imgs,
      {
        ...
        captions: <?php echo ($showCaption==1?'true':'false'); ?>,
