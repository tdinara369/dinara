...
return [
    ...
    'timestamp' => 1493398184,
    'checksum' => 'ccfcc07928d37e46c537a3cf510fec4c',
    'files' => [
        'templates/jl_ifolio_free/custom/particles' => [
            'particles/backtotop' => [
                'file' => 'templates/jl_ifolio_free/custom/particles/backtotop.yaml',
                'modified' => 1493398175
            ]
        ],
        'templates/jl_ifolio_free/particles' => [
            'particles/contentcubes' => [
                'file' => 'templates/jl_ifolio_free/particles/contentcubes.yaml',
                'modified' => 1493398175
            ],
            'particles/contenttabs' => [
                'file' => 'templates/jl_ifolio_free/particles/contenttabs.yaml',
                'modified' => 1493398175
            ],
            'particles/copyright' => [
                'file' => 'templates/jl_ifolio_free/particles/copyright.yaml',
                'modified' => 1493398175
            ],
            'particles/horizontalmenu' => [
                'file' => 'templates/jl_ifolio_free/particles/horizontalmenu.yaml',
                'modified' => 1493398175
            ],
            'particles/owlcarousel' => [
                'file' => 'templates/jl_ifolio_free/particles/owlcarousel.yaml',
                'modified' => 1493398175
            ],
            'particles/sidemenu' => [
                'file' => 'templates/jl_ifolio_free/particles/sidemenu.yaml',
                'modified' => 1493398175
            ]
        ],
        ...
        'templates/jl_ifolio_free/blueprints' => [
            'styles/above' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/above.yaml',
                'modified' => 1493398175
            ],
            'styles/above-footer' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/above-footer.yaml',
                'modified' => 1493398175
            ],
            'styles/accent' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/accent.yaml',
                'modified' => 1493398175
            ],
            'styles/base' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/base.yaml',
                'modified' => 1493398175
            ],
            'styles/blog' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/blog.yaml',
                'modified' => 1493398175
            ],
            'styles/bottom' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/bottom.yaml',
                'modified' => 1493398175
            ],
            'styles/breakpoints' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/breakpoints.yaml',
                'modified' => 1493398175
            ],
            'styles/clients' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/clients.yaml',
                'modified' => 1493398175
            ],
            'styles/features' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/features.yaml',
                'modified' => 1493398175
            ],
            'styles/fixedside' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/fixedside.yaml',
                'modified' => 1493398175
            ],
            'styles/font' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/font.yaml',
                'modified' => 1493398175
            ],
            'styles/footer' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/footer.yaml',
                'modified' => 1493398175
            ],
            'styles/intro' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/intro.yaml',
                'modified' => 1493398175
            ],
            'styles/menu' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/menu.yaml',
                'modified' => 1493398175
            ],
            'styles/offcanvas' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/offcanvas.yaml',
                'modified' => 1493398175
            ],
            'styles/slideshow' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/slideshow.yaml',
                'modified' => 1493398175
            ],
            'styles/testimonials' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/testimonials.yaml',
                'modified' => 1493398175
            ],
            'styles/top' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/top.yaml',
                'modified' => 1493398175
            ],
            'styles/utility' => [
                'file' => 'templates/jl_ifolio_free/blueprints/styles/utility.yaml',
                'modified' => 1493398175
            ]
        ],
    ...
    'data' => [
        'items' => [
            ...
            'styles.above-footer.background' => [
                'type' => 'input.colorpicker',
                'label' => 'Background',
                'default' => '#f4f5f7',
                'name' => 'styles.above-footer.background'
            ],
            'styles.above-footer.text-color' => [
                'type' => 'input.colorpicker',
                'label' => 'Text',
                'default' => '#424753',
                'name' => 'styles.above-footer.text-color'
            ],
            'styles.accent' => [
                'form' => [
            ...
            'styles.blog.background' => [
                'type' => 'input.colorpicker',
                'label' => 'Background',
                'default' => '#f5f7f8',
                'name' => 'styles.blog.background'
            ],
            'styles.blog.text-color' => [
                'type' => 'input.colorpicker',
                'label' => 'Text',
                'default' => '#242526',
                'name' => 'styles.blog.text-color'
            ],
            'styles.bottom' => [
                'form' => [
            ...
            'styles.clients.background' => [
                'type' => 'input.colorpicker',
                'label' => 'Background',
                'default' => '#f4f5f7',
                'name' => 'styles.clients.background'
            ],
            'styles.clients.text-color' => [
                'type' => 'input.colorpicker',
                'label' => 'Text',
                'default' => '#424753',
                'name' => 'styles.clients.text-color'
            ],
            'styles.features' => [
                'form' => [
        ...
        'nested' => [
            ...
            'styles' => [
                ...
                'above-footer' => [
                    'background' => 'styles.above-footer.background',
                    'text-color' => 'styles.above-footer.text-color'
                ],
                'accent' => [
                ...
                'blog' => [
                    'background' => 'styles.blog.background',
                    'text-color' => 'styles.blog.text-color'
                ],
                'bottom' => [
                ...
                'clients' => [
                    'background' => 'styles.clients.background',
                    'text-color' => 'styles.clients.text-color'
                ],
                'features' => [
