...
return [
    ...
    '_version' => 1,
    'id' => '590cad41c50da6.77521786',
    'content' => '<div class="g-content g-particle">
                                    <div class="fp-features">
    <div class="g-grid" style=”border-style: ridge;” >
...
<div class="g-block size-68" >
            <div class="card">
                <div class="card-block" >
                 <h6 class="card-title" style="font-size:20px; padding-top:45px;">Качественная косметика</h6>
