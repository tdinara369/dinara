...
return [
    ...
    <div class="g-grid">
        <div class="g-block size-32" style="border-style: ridge; margin-right:10px;">
            <div class="card">
                <div class="card-block">
                 <img src="/images/cosmetics.png?590c9f77" alt="Best Cosmetics" style="text-align:center;"/> 
                    <h6 class="card-title" style="font-size:20px;">Качественная косметика</h6>
        ...
        <div class="g-block size-32" style="border-style: ridge; margin-right:10px;">
            <div class="card">
                <div class="card-block">
                   <img src="/images/sampledata/makeup.png?590ca9dd" alt="MakeUp"/> 
                    <h6 class="card-title" style="font-size:20px;">Лучший Визажист города</h6>
        ...
        <div class="g-block size-32" style="border-style: ridge;">
            <div class="card">
                <div class="card-block">
                    <img src="/images/sampledata/magic-min.jpg?590ca9dd" alt="Magic-Box" /> 
                    <h6 class="card-title" style="font-size:20px;">Необычные подарки</h6>
