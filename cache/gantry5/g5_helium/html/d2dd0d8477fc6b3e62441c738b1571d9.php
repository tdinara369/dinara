...
return [
    ...
    '_version' => 1,
    'id' => '590af529df2839.66235197',
    'content' => '<div class="g-content g-particle">
                            
    <div class="">
        
        <div id="g-owlcarousel-owlcarousel-8938" class="g-owlcarousel owl-carousel has-color-overlay">

                            <div class="g-owlcarousel-item owl-item">
                    <div class="g-owlcarousel-item-wrapper">
                        <div class="g-owlcarousel-item-img">
                            <img src="/images/hea.jpg?5903943f" alt="Не знаешь где поесть вкусное мороженое?" />
                        </div>
                        <div class="g-owlcarousel-item-content-container">
                            <div class="g-owlcarousel-item-content-wrapper">
                                <div class="g-owlcarousel-item-content">
                                            ...
                                            <a target="_self" class="g-owlcarousel-item-button button submit" href="отзывы">
